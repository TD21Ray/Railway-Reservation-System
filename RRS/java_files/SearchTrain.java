        ...
        try {
            ...
            for(int i = 0; i < trlist.length; i++) {
                if(trlist[i][0] != null) {
                    ...
                    trlistcontent += "<td><button class='open-button' onclick='booknow(document.getElementById(\"tnamein\").innerHTML, document.getElementById(\"tnoin\").innerHTML, document.getElementById(\"pricein\").innerHTML, document.getElementById(\"dotin\").innerHTML, document.getElementById(\"srcin\").innerHTML, document.getElementById(\"desin\").innerHTML, document.getElementById(\"seatsin\").innerHTML, document.getElementById(\"durin\").innerHTML);'>Book Ticket</button></td>";
                    trlistcontent += "</tr>";
                }
            }
            trlistcontent += "</table>";
